...
public class ProductCompositeServiceApplicationTests {
	...
	public void setUp() {
		...
		when(compositeIntegration.getProduct(any(), eq(PRODUCT_ID_OK), anyInt(), anyInt())).thenReturn(Mono.just(new Product(PRODUCT_ID_OK, "name", 1, "mock-address")));
		...
		when(compositeIntegration.getReviews(any(), eq(PRODUCT_ID_OK))).thenReturn(Flux.fromIterable(singletonList(new Review(PRODUCT_ID_OK, 1, "author", "subject", "content", "mock address"))));
